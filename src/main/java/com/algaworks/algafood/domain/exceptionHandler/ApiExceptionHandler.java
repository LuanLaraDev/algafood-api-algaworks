...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleIgnoredProperty(
        ...
        String propriedade = joinPath(ex.getPath());
    ...
    private ResponseEntity<Object> handleUncategorized(Exception ex, WebRequest request) {
    ...
    private String joinPath(List<Reference> references) {
        return references.stream().map(path -> path.getFieldName()).collect(Collectors.joining("."));
    }
}
